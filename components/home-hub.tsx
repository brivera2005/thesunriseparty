          ...
          <div className="mx-auto flex max-w-6xl flex-col items-center gap-3 px-4 py-6 text-center sm:flex-row sm:justify-center sm:px-6 sm:py-8">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Pass 34 verifiable-room milestone - Schedule F continuity, metals
                tariffs, DPA waivers, housing stacks, elections mandates, and lands
                deregulation now documented.{" "}
                <Link
                  href="/tracker/EVT-2026-0711-320"
                  className="font-medium text-primary underline-offset-4 hover:underline"
                >
                  See event #320 →
                </Link>
        ...
        >
          <div className="mx-auto flex max-w-6xl flex-col items-center gap-3 px-4 py-6 text-center sm:flex-row sm:justify-center sm:px-6 sm:py-8">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Pass 33 verifiable-room milestone - Schedule F continuity, metals
                tariffs, DPA waivers, housing stacks, elections mandates, and lands
                deregulation now documented.{" "}
                <Link
                  href="/tracker/EVT-2026-0711-300"
                  className="font-medium text-primary underline-offset-4 hover:underline"
                >
                  See event #300 →
                </Link>
        ...
        >
          <div className="mx-auto flex max-w-6xl flex-col items-center gap-3 px-4 py-6 text-center sm:flex-row sm:justify-center sm:px-6 sm:py-8">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Pass 32 verifiable-room milestone - Schedule F continuity, metals
                tariffs, DPA waivers, housing stacks, and elections mandates now
                documented.{" "}
                <Link
                  href="/tracker/EVT-2026-0711-280"
                  className="font-medium text-primary underline-offset-4 hover:underline"
                >
                  See event #280 →
                </Link>
