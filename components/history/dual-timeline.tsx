...
import { hiddenHistoryEntries } from "@/lib/data/hidden-history";
    ...
    <div className="relative">
          ...
          <div className="relative mt-3 h-8">
            {eraTicks.map((tick) => (
              <div
                ...
                style={{ left: `${yearToPercent(tick.year, yearMin, yearMax)}%` }}
              >
      ...
      <div className="mt-6 space-y-2 md:hidden">
        {sorted.map((entry) => (
          ...
          >
            <p className="text-xs text-muted-foreground">{entry.date} · {entry.era}</p>
