...
export function HistoryPage() {
  ...
  const activeFilterCount =
    (activeCategory !== "All" ? 1 : 0) + (activeEra !== "All" ? 1 : 0);
  ...
  return (
    <PageShell>
      ...
      <section className="sticky top-14 z-30 border-b border-border bg-white/95 backdrop-blur-lg sm:top-16">
        <div className="page-container py-3">
          <CollapsibleFilters
            activeCount={activeFilterCount}
            label="Filters"
            summary={`${filtered.length} results`}
