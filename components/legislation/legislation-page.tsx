  ...
  return (
    <PageShell>
      <PageHero
        ...
        title="Legislation"
        description="Active House and Senate bills with party-colored sponsors, vote tallies when available, and progressive analysis grounded in the text — not fearmongering."
        tip="Filters and bill cards use the same layout on mobile and desktop. Vote bars show yea/nay broken down by party."
        actions={
