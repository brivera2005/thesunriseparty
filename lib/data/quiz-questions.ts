...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    help: "'America First' vs 'globalist' is a branding fight. Supporting alliances and trade is not hating America. Veterans and workers can want strong partnerships without forever wars. The real choices are alliances, deterrence, diplomacy, and when force is justified.",
    type: "choice",
    options: [
      {
  ...
  },
  {
    ...
    help: "Equal rights under law is not 'forcing ideology on kids' or 'woke indoctrination.' Churchgoers can keep their doctrine while the state and employers do not discriminate. The fight is civil rights and medical access, not whether parents love their children.",
    type: "choice",
    options: [
      {
        id: "full-equality",
  ...
  },
  {
    ...
    help: "Asking the ultra-rich to pay more is not 'punishing success.' Inequality is not only envy. It shapes who owns media, funds campaigns, and sets wages.",
    options: [
      {
        id: "wealth-0",
