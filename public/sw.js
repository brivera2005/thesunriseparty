/* Project Sunrise service worker - Pass 52 hard cache bust.
 * Comprehensive mobile UX: hero actions, filter sheets, grid reorder.
 */
const CACHE = "sunrise-v52-20260713T1815-mobile";
const PRECACHE = [
